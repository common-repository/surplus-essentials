...
// register Surplus_Essentials_Advertisement_Widget widget
function ste_register_advertisement_widget(){
    register_widget( 'Surplus_Essentials_Advertisement_Widget' );
}
add_action('widgets_init', 'ste_register_advertisement_widget');
 
 /**
 * Adds Surplus_Essentials_Advertisement_Widget widget.
 */
class Surplus_Essentials_Advertisement_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
			'ste_advertisement_widget', // Base ID
			__( 'SE: Advertisement Widget', 'surplus-essentials' ), // Name
			array( 'description' => __( 'An Advertisement Widget.', 'surplus-essentials' ), ) // Args
		);
    }
    ...
    public function widget( $args, $instance ) {
        ...
        if( $image ){
            ...
            $icon_img_size = apply_filters( 'ste_ad_img_size', 'full' );   
        }else{
        	$code = $code;
        }
        ...
        ob_start(); 
        ?>        
            <div class="ste-add-holder">
                <div class="ste-add-inner-holder">
        ...
        <?php
        $html = ob_get_clean();
        echo apply_filters( 'ste_advertisement_widget_filter', $html, $args, $instance );    
	...
	public function form( $instance ) {
        ...
        <p>
            <label><?php _e('Display Advertisement from:','surplus-essentials'); ?></label>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'advertisement-option' ) . '-text' );?>" class="radio-btn-wrap"><?php _e('Ad Code','surplus-essentials');?></label>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'advertisement-option' ) . '-photo' );?>" class="radio-btn-wrap"><?php _e('Upload Photo','surplus-essentials');?></label>
        </p>
        ...
        <p class="ad-link">
            <label for="<?php echo esc_attr( $this->get_field_id( 'code' ) ); ?>"><?php esc_html_e( 'Ad Code', 'surplus-essentials' ); ?></label> 
...
}  // class Surplus_Essentials_Advertisement_Widget / class Surplus_Essentials_Advertisement_Widget 