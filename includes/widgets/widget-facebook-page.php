...
// register Surplus_Essentials_Facebook_Page_Widget widget.
function ste_register_facebook_page_widget(){
    register_widget( 'Surplus_Essentials_Facebook_Page_Widget' );
}
add_action('widgets_init', 'ste_register_facebook_page_widget');
 
 /**
 * Adds Surplus_Essentials_Facebook_Page_Widget widget.
 */
class Surplus_Essentials_Facebook_Page_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
			'ste_facebook_page_widget', // Base ID
			__( 'SE: Facebook Page', 'surplus-essentials' ), // Name
			array( 'description' => __( 'A widget that shows Facebook Page Box', 'surplus-essentials' ), ) // Args
		);
    }
    ...
    public function widget( $args, $instance ) {
        ...
        <div class="ste-facebook-page-box">
        <?php
        ...
        <?php
        $html = ob_get_clean();
        echo apply_filters( 'ste_facebook_page_widget_filter', $html, $args, $instance ); 
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'page_url' ) ); ?>"><?php esc_html_e( 'Facebook Page URL', 'surplus-essentials' ); ?></label> 
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'height' ) ); ?>"><?php esc_html_e( 'Height', 'surplus-essentials' ); ?></label> 
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_faces' ) ); ?>"><?php esc_html_e( "Show Friend's Faces", 'surplus-essentials' ); ?></label>
		</p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'small_header' ) ); ?>"><?php esc_html_e( 'Use Small Header', 'surplus-essentials' ); ?></label>
		</p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'hide_cover_photo' ) ); ?>"><?php esc_html_e( 'Hide Cover Photo', 'surplus-essentials' ); ?></label>
		</p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_timeline_tab' ) ); ?>"><?php esc_html_e( 'Show Timeline Tab', 'surplus-essentials' ); ?></label>
		</p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_event_tab' ) ); ?>"><?php esc_html_e( 'Show Event Tab', 'surplus-essentials' ); ?></label>
		</p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_msg_tab' ) ); ?>"><?php esc_html_e( 'Show Message Tab', 'surplus-essentials' ); ?></label>
		</p>
		<?php 
	}
...
}  // class Surplus_Essentials_Facebook_Page_Widget / class Surplus_Essentials_Facebook_Page_Widget 